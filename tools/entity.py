...
class URI_KG(object):
    ...
    avoid_predicates.add(
        "http://purl.org/dc/terms/subject")  #Link to categories
    ...
    avoid_top_concepts.add(
        "http://www.wikidata.org/entity/Q23958946")  #individual/instance
    avoid_top_concepts.add(
        "http://www.wikidata.org/entity/Q26720107")  # subject of a right
    ...
    avoid_top_concepts.add(
        "http://www.wikidata.org/entity/Q16686022")  # natural physical object
...
class KGEntity(object):
    ...
    def __repr__(self):
        return "<id: %s, label: %s, description: %s, types: %s, source: %s>" % (
            self.ident, self.label, self.desc, self.types, self.source)
