...
def compareWithReference(reference_mappings_file, system_mappings_file):
    ...
    #print(fp)
    #print(fn)
    print("Comparing '" + system_mappings_file + "' with '" +
          reference_mappings_file)
...
if __name__ == '__main__':
    ...
    compareWithReference(
        "../lab-session3/data/anatomy-reference-mappings.ttl",
        "../lab-session3/data/anatomy-example-system-mappings.ttl")
